...
export const CONSONANTS: HindiCharacter[] = [
  ...
  {
    char: "ङ", transliteration: "nga",
    examples: [
      { word: "पंक्ति", transliteration: "pankti", meaning: "row/line" },
    ],
  },
  {
    char: "च", transliteration: "cha",
    examples: [
  ...
  {
    char: "ञ", transliteration: "nya",
    examples: [
      { word: "ज्ञान", transliteration: "gyaan", meaning: "knowledge" },
    ],
  },
  {
    char: "ट", transliteration: "ta",
    examples: [
  ...
  {
    char: "ष", transliteration: "sha",
    examples: [
      { word: "षट्कोण", transliteration: "shatkon", meaning: "hexagon" },
    ],
  },
  {
    char: "स", transliteration: "sa",
    examples: [
...
export const HALF_CONSONANTS: HalfConsonant[] = [
  {
    full: "क", half: "क्", transliteration: "k", example: "क्त", exampleMeaning: "k+ta",
    examples: [
      { word: "क्रम", transliteration: "kram", meaning: "order" },
      { word: "क्षण", transliteration: "kshan", meaning: "moment" },
    ],
  },
  { full: "ख", half: "ख्", transliteration: "kh", example: "ख्याल", exampleMeaning: "thought" },
  {
    full: "ग", half: "ग्", transliteration: "g", example: "ग्राम", exampleMeaning: "village",
    examples: [
      { word: "ग्रह", transliteration: "grah", meaning: "planet" },
      { word: "ग्रीष्म", transliteration: "griishm", meaning: "summer" },
    ],
  },
  { full: "घ", half: "घ्", transliteration: "gh", example: "घ्राण", exampleMeaning: "smell" },
  { full: "च", half: "च्", transliteration: "ch", example: "च्यवन", exampleMeaning: "fall" },
  { full: "ज", half: "ज्", transliteration: "j", example: "ज्ञान", exampleMeaning: "knowledge" },
  { full: "ट", half: "ट्", transliteration: "t", example: "ट्रक", exampleMeaning: "truck" },
  { full: "ड", half: "ड्", transliteration: "d", example: "ड्रामा", exampleMeaning: "drama" },
  {
    full: "त", half: "त्", transliteration: "t", example: "त्वचा", exampleMeaning: "skin",
    examples: [
      { word: "त्वचा", transliteration: "tvacha", meaning: "skin" },
      { word: "त्रुटि", transliteration: "truti", meaning: "error" },
    ],
  },
  { full: "थ", half: "थ्", transliteration: "th", example: "थ्रिलर", exampleMeaning: "thriller" },
  {
    full: "द", half: "द्", transliteration: "d", example: "द्वार", exampleMeaning: "door",
    examples: [
      { word: "द्वार", transliteration: "dvaar", meaning: "door" },
      { word: "द्वीप", transliteration: "dviip", meaning: "island" },
    ],
  },
  { full: "ध", half: "ध्", transliteration: "dh", example: "ध्यान", exampleMeaning: "attention" },
  {
    full: "न", half: "न्", transliteration: "n", example: "न्याय", exampleMeaning: "justice",
    examples: [
  ...
  {
    full: "प", half: "प्", transliteration: "p", example: "प्रेम", exampleMeaning: "love",
    examples: [
      { word: "प्रेम", transliteration: "prem", meaning: "love" },
      { word: "प्रकाश", transliteration: "prakaash", meaning: "light" },
    ],
  },
  { full: "फ", half: "फ्", transliteration: "ph", example: "फ्रूट", exampleMeaning: "fruit" },
  {
    full: "ब", half: "ब्", transliteration: "b", example: "ब्रह्म", exampleMeaning: "brahma",
    examples: [
      { word: "ब्रह्म", transliteration: "brahm", meaning: "divine" },
      { word: "ब्राह्मण", transliteration: "brahman", meaning: "brahmin" },
    ],
  },
  { full: "भ", half: "भ्", transliteration: "bh", example: "भ्रमण", exampleMeaning: "travel" },
  {
    full: "म", half: "म्", transliteration: "m", example: "म्यूजिक", exampleMeaning: "music",
    examples: [
      { word: "म्यूजिक", transliteration: "myuujik", meaning: "music" },
    ],
  },
  { full: "य", half: "य्", transliteration: "y", example: "य्वान", exampleMeaning: "youth" },
  { full: "र", half: "र्", transliteration: "r", example: "र्क", exampleMeaning: "(suffix)" },
  { full: "ल", half: "ल्", transliteration: "l", example: "ल्हासा", exampleMeaning: "Lhasa" },
  {
    full: "व", half: "व्", transliteration: "v", example: "व्यापार", exampleMeaning: "business",
    examples: [
  ...
  {
    full: "श", half: "श्", transliteration: "sh", example: "श्रम", exampleMeaning: "labor",
    examples: [
      { word: "श्रम", transliteration: "shram", meaning: "labor" },
      { word: "श्रेष्ठ", transliteration: "shresth", meaning: "best" },
    ],
  },
  { full: "ष", half: "ष्", transliteration: "sh", example: "ष्टि", exampleMeaning: "(suffix)" },
  {
    full: "स", half: "स्", transliteration: "s", example: "स्कूल", exampleMeaning: "school",
    examples: [
  ...
  {
    full: "ह", half: "ह्", transliteration: "h", example: "ह्रदय", exampleMeaning: "heart",
    examples: [
      { word: "ह्रदय", transliteration: "hraday", meaning: "heart" },
    ],
  },
];
...
export const WORD_EXAMPLES: WordExample[] = [
  { word: "काम", parts: [{ char: "क", role: "consonant" }, { char: "ा", role: "matra" }, { char: "म", role: "consonant" }], transliteration: "kaam", meaning: "work" },
  { word: "पानी", parts: [{ char: "प", role: "consonant" }, { char: "ा", role: "matra" }, { char: "न", role: "consonant" }, { char: "ी", role: "matra" }], transliteration: "paani", meaning: "water" },
  { word: "घर", parts: [{ char: "घ", role: "consonant" }, { char: "र", role: "consonant" }], transliteration: "ghar", meaning: "home" },
  { word: "नमस्ते", parts: [{ char: "न", role: "consonant" }, { char: "म", role: "consonant" }, { char: "स्", role: "consonant" }, { char: "त", role: "consonant" }, { char: "े", role: "matra" }], transliteration: "namaste", meaning: "hello" },
  { word: "किताब", parts: [{ char: "क", role: "consonant" }, { char: "ि", role: "matra" }, { char: "त", role: "consonant" }, { char: "ा", role: "matra" }, { char: "ब", role: "consonant" }], transliteration: "kitaab", meaning: "book" },
  { word: "दिल", parts: [{ char: "द", role: "consonant" }, { char: "ि", role: "matra" }, { char: "ल", role: "consonant" }], transliteration: "dil", meaning: "heart" },
  { word: "सूरज", parts: [{ char: "स", role: "consonant" }, { char: "ू", role: "matra" }, { char: "र", role: "consonant" }, { char: "ज", role: "consonant" }], transliteration: "suuraj", meaning: "sun" },
  { word: "खेत", parts: [{ char: "ख", role: "consonant" }, { char: "े", role: "matra" }, { char: "त", role: "consonant" }], transliteration: "khet", meaning: "field" },
];

// Syllable examples for Khadi page popover
export const SYLLABLE_EXAMPLES: Record<string, { word: string; transliteration: string; meaning: string }[]> = {
...
export const DICTATION_WORDS: DictationWord[] = [
  // Simple words
  { word: "नमस्ते", transliteration: "namaste", meaning: "hello", category: "simple", distractors: ["नमसते", "नामस्ते", "नमस्ती"] },
  { word: "घर", transliteration: "ghar", meaning: "home", category: "simple", distractors: ["गर", "खर", "हर"] },
  { word: "रात", transliteration: "raat", meaning: "night", category: "simple", distractors: ["रट", "रात्र", "रैत"] },
  { word: "दिन", transliteration: "din", meaning: "day", category: "simple", distractors: ["दीन", "दन", "दिण"] },
  // Matra words
  { word: "पानी", transliteration: "paani", meaning: "water", category: "matra", distractors: ["पनी", "पाणी", "पानि"] },
  { word: "किताब", transliteration: "kitaab", meaning: "book", category: "matra", distractors: ["कीताब", "किताव", "कताब"] },
  { word: "फूल", transliteration: "phul", meaning: "flower", category: "matra", distractors: ["फुल", "फल", "फूले"] },
  { word: "दूध", transliteration: "duudh", meaning: "milk", category: "matra", distractors: ["दुध", "दूद", "दूढ"] },
  { word: "सेब", transliteration: "seb", meaning: "apple", category: "matra", distractors: ["सब", "सेव", "शेब"] },
  { word: "केला", transliteration: "kela", meaning: "banana", category: "matra", distractors: ["कला", "कैला", "केल"] },
  { word: "गाना", transliteration: "gaana", meaning: "song", category: "matra", distractors: ["गना", "गाण", "गाने"] },
  { word: "नाम", transliteration: "naam", meaning: "name", category: "matra", distractors: ["नम", "नाव", "नाण"] },
  // Half letter words
  { word: "स्कूल", transliteration: "skuul", meaning: "school", category: "half", distractors: ["सकूल", "स्कुल", "स्कूले"] },
  { word: "प्रेम", transliteration: "prem", meaning: "love", category: "half", distractors: ["परेम", "प्रेव", "प्रेन"] },
  { word: "ज्ञान", transliteration: "gyaan", meaning: "knowledge", category: "half", distractors: ["जान", "ज्यान", "गयान"] },
  { word: "द्वार", transliteration: "dvaar", meaning: "door", category: "half", distractors: ["दवार", "द्वर", "दुवार"] },
  { word: "व्यापार", transliteration: "vyaapaar", meaning: "business", category: "half", distractors: ["व्यापर", "वयापार", "व्यापाल"] },
  { word: "ध्यान", transliteration: "dhyaan", meaning: "attention", category: "half", distractors: ["धयान", "ध्यन", "दयान"] },
  // Conjunct/complex
  { word: "क्षमा", transliteration: "kshama", meaning: "forgiveness", category: "conjunct", distractors: ["क्षम", "खमा", "क्शमा"] },
  { word: "त्वचा", transliteration: "tvacha", meaning: "skin", category: "conjunct", distractors: ["तवचा", "त्वचे", "त्बचा"] },
  { word: "श्रम", transliteration: "shram", meaning: "labor/effort", category: "conjunct", distractors: ["शरम", "श्रन", "शर्म"] },
  { word: "ग्रह", transliteration: "grah", meaning: "planet/house", category: "conjunct", distractors: ["गरह", "ग्रहम", "ग्राह"] },
  { word: "भ्रमण", transliteration: "bhraman", meaning: "travel", category: "conjunct", distractors: ["भरमण", "भ्रमन", "भरमन"] },
];
