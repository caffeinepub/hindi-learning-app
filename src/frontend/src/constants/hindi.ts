...
export const DICTATION_ITEMS: DictationItem[] = [
  ...
  {
    id: "s12",
    text: "वह बाज़ार से सब्ज़ियाँ लाई।",
    transliteration: "Vah baazaar se sabziyan laai.",
    meaning: "She brought vegetables from the market.",
    difficulty: "medium",
    mode: "sentence",
  },
  {
    ...
    transliteration: "Bacche school jaate hain.",
    meaning: "Children go to school.",
    difficulty: "easy",
    mode: "sentence",
  },
  {
  ...
  {
    id: "s15",
    text: "मुझे हिंदी सीखना अच्छा लगता है।",
    transliteration: "Mujhe Hindi seekhna achha lagta hai.",
    meaning: "I enjoy learning Hindi.",
    difficulty: "medium",
    mode: "sentence",
  },
  {
    id: "s16",
    text: "परिश्रम सफलता की कुंजी है।",
    transliteration: "Parishram saphalata ki kunji hai.",
    meaning: "Hard work is the key to success.",
    difficulty: "hard",
    mode: "sentence",
  },
  {
    id: "s17",
    text: "नदी में बहुत पानी है।",
    transliteration: "Nadi mein bahut paani hai.",
    meaning: "There is a lot of water in the river.",
    difficulty: "medium",
    mode: "sentence",
  },
  {
    id: "s18",
    text: "वे सुबह योगाभ्यास करते हैं।",
    transliteration: "Ve subah yogaabhyas karte hain.",
    meaning: "They practice yoga in the morning.",
    difficulty: "hard",
    mode: "sentence",
  },
  {
    id: "s19",
    text: "आसमान में बादल छाए हैं।",
    transliteration: "Aasman mein baadal chhae hain.",
  ...
  {
    id: "s20",
    text: "मेरा परिवार बहुत प्यारा है।",
    transliteration: "Mera parivar bahut pyaara hai.",
    meaning: "My family is very lovely.",
    difficulty: "easy",
    mode: "sentence",
  },
  {
    id: "s21",
    text: "विद्यार्थियों ने परीक्षा में अच्छे अंक पाए।",
    transliteration: "Vidyarthiyon ne pariksha mein achhe ank paaye.",
    meaning: "The students scored good marks in the exam.",
    difficulty: "hard",
    mode: "sentence",
  },
];
